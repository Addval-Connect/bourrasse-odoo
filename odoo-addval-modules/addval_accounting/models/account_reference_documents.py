...
class AccountInvoiceReference(models.Model):
    ...
    reference_documents = [
        ...
        ("820", "(820) Inscripcion de Acuerdo Plazo de Pago"),
        (
            "901",
            "(901) Factura de ventas a empresas del territorio preferencial Res. Ex. N° 1057",
        ),
    ...
    l10n_cl_reference_doc_type_selection = fields.Selection(
        reference_documents, string="SII Doc Type Selector", required=True
    )
