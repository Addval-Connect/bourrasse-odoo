...
class MonetaryConverter(models.Model):
    ...
    Two decimal places are used for romating formatting and no rounding is applyed to the float value.
    ...
    _name = "ir.qweb.field.monetary_two_decimals"
    _description = "Qweb Field Monetary two decimals"
